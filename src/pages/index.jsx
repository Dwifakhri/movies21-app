      ...
      <div className="flex flex-row space-x-1">
        <iframe
          className={
            appear === false
              ? "hidden"
              : "inline z-100 fixed top-72 md:top-40 lg:top-24 px-12"
          }
          id="frame"
          width="100%"
          height="550"
        ...
        <div
          ...
          className={
            appear === false
              ? "hidden"
              : " inline cursor-pointer z-100 fixed top-72 md:top-40 lg:top-24 text-putih dark:text-red-600 p-2 bg-black"
          }>
          ✕
        </div>
      </div>
